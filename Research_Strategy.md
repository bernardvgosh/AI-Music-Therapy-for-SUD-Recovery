# AI & Music-Based Therapy in SUD Recovery — Research Strategy

**Research Strategy, Plan, and Working Instructions**

*Exploring the Use of Artificial Intelligence and Music-Based Therapy in Supporting Individuals with Drug Addiction and Substance Use Disorder*
...
The decisive caveat for this study is that music is not unambiguously protective. A systematic review by Silverman and colleagues (2023) found that music can induce craving for substances including alcohol, cannabis, and nicotine by acting as a contextual cue, and qualitative work confirms that people in recovery are often acutely aware of songs and genres that function as drug cues. *(Citation flagged as unconfirmed — verify against the primary record before this appears in any submitted material.)* This means the craving pillar cannot be framed simply as "music reduces craving"; the more accurate framing is that music is a powerful affective and associative stimulus whose effect on craving is context-, person-, and content-dependent, and that therapeutic skill lies partly in working with that ambivalence rather than assuming benefit.
...
**Option C — Primary empirical study.** A small qualitative study (interviews with clinicians, music therapists, or — with heavy ethical safeguards — people in recovery), a feasibility/usability study of a tool, or a prototype evaluation. This carries the highest ethical and logistical load (see Section 7) and would require full ethics-board approval and likely clinical collaboration. Only pursue if scope, time, and supervision genuinely support it.
...
- **Risk of over-reliance and false reassurance.** Affect-detection and recommendation systems can present more certainty than they possess (see Section 4.3). Over-reliance on an automated tool — especially a conversational agent during a crisis — is a genuine safety concern. Note where a tool could give unsafe or inaccurate guidance and what safeguards (human oversight, escalation to crisis resources, clinical validation) are needed.
...
- **Surface limitations proactively** — methodological caveats, thin or contested evidence, and the ethical concerns in Section 7 — rather than waiting to be asked. A limitations section is necessary but not sufficient; caveats belong next to the claims they qualify.
